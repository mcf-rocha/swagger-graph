...
![Graph generated by Swagger-Graph](https://github.com/mcf-rocha/swagger-graph/blob/master/example/PetStore-graph.png?raw=true)

### Graph from more than one Swagger APIs
![Graph generated by Swagger-Graph](https://github.com/mcf-rocha/swagger-graph/blob/master/example/more-than-one-api-graph.png?raw=true)